# JobMonitor — Мониторинг вакансий из VK и рассылка их ботом Telegram в реальном времени
Небольшой Telegram-бот для отслеживания объявлений (вакансий) в реальном времени из VK и рассылки их подписчикам.
